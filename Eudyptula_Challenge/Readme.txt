...
write, modify, and submit Linux kernel patches and code of all sorts of
different types.

First off, some housekeeping rules.

You have been assigned a "unique" id.  This id is required when
submitting your results, as me (a dumb script) needs some way to
determine what is going on.  So, please, for every email you write to me
from now on, please use your id in the Subject: line like this:

    [35263a1c7214] Task 02 results

And yes, if you haven't guessed it already, "35263a1c7214" is your
...
client / server and try it again.  Ah, now you see why you use an id and
not an email address, we didn't just fall off of the turnip truck
yesterday.
...
Responses to submissions can sometimes take a few days, or it can be a
few minutes, depending on the load of the system.  There are well over a
thousand people currently taking this challenge and the scripts get
easily backlogged at times.  If you ever feel that you missed an email,
just ask, and research will be done to see what happened.  Sometimes new
task emails do get delayed, but it should only be an hour or so, never
more than a day to get a new task once you have completed one.  If you
have not received a new task within a day of a task being marked as
completed, please send a reminder email to find out what went wrong.
...
going on, and I will get back to you in a few days with answers.
